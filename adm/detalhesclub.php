...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql_update = "UPDATE projetolivro SET user = '$turma', nomelivro = '$titulo' WHERE id = '$id'";
  $conn->query($sql_update);

  header("Location: detalhesclub.php?id=$id");
  exit();
}

$sql = "SELECT * FROM projetolivro WHERE id = '$id'";
...
if ($result->num_rows > 0) {
  ...
  <form method="POST" action="detalhesclub.php?id=<?php echo $id; ?>" enctype="multipart/form-data">
